...
const getByNumber = require('./controllers/userController')
...
const flowUsuarioNoRegistrado = addKeyword(['gracias', 'grac']).addAnswer(
    [
...
const flowUsuarioRegistrado = addKeyword(['discord']).addAnswer(
